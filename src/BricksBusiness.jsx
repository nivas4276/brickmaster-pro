...
// ── THEME ─────────────────────────────────────────────────────────────────────
const T = {
  // Premium light theme: warm, clean and easier to use on iPad.
  bg: "#f6f3ee",
  surface: "#fffaf3",
  card: "#ffffff",
  border: "#e7ded2",
...
const LANG_KEY = "brickmaster_language";
const HISTORY_KEY = "brickmaster_change_history";
const REDO_KEY = "brickmaster_redo_history";

const TE = {
  "Home": "హోమ్", "Stock": "స్టాక్", "Production": "ఉత్పత్తి", "Materials": "మెటీరియల్స్",
  "Sales": "సేల్స్", "Customers": "కస్టమర్లు", "Salaries": "జీతాలు", "Expenses": "ఖర్చులు",
  "Suppliers": "సప్లయర్లు", "Reports": "రిపోర్ట్స్", "History": "చరిత్ర",
  "BrickMaster Pro": "బ్రిక్‌మాస్టర్ ప్రో", "Flyash Bricks Business Manager": "ఫ్లైయాష్ బ్రిక్స్ బిజినెస్ మేనేజర్",
  "Refresh": "రిఫ్రెష్", "Undo": "అన్‌డూ", "Redo": "రీడూ",
  "TOTAL REVENUE": "మొత్తం ఆదాయం", "OUTSTANDING": "బాకీ", "TODAY PRODUCTION": "ఈరోజు ఉత్పత్తి",
  "TOTAL STOCK": "మొత్తం స్టాక్", "TOTAL EXPENSES": "మొత్తం ఖర్చులు", "NET PROFIT": "నికర లాభం",
  "BEST MONTH": "ఉత్తమ నెల", "TOTAL SALARY PAID": "చెల్లించిన మొత్తం జీతం", "THIS WEEK": "ఈ వారం",
  "TODAY": "ఈరోజు", "BRICKS THIS WEEK": "ఈ వారం ఇటుకలు", "TOTAL TO PAY": "చెల్లించాల్సిన మొత్తం",
  "TOTAL SALES": "మొత్తం అమ్మకాలు", "PAID": "చెల్లించినది", "INSTALMENTS": "వాయిదాలు",
  "Sales & Customers": "సేల్స్ & కస్టమర్లు", "By Customer": "కస్టమర్ వారీగా", "Dues": "బాకీలు",
  "All pending customer collections": "పెండింగ్ కస్టమర్ కలెక్షన్లు", "No outstanding dues!": "బాకీలు లేవు!",
  "No customers added yet.": "ఇంకా కస్టమర్లు చేర్చలేదు.", "No sales added yet.": "ఇంకా సేల్స్ చేర్చలేదు.",
  "No workers added yet.": "ఇంకా కార్మికులను చేర్చలేదు.", "No expenses added yet.": "ఇంకా ఖర్చులు చేర్చలేదు.",
  "No suppliers added yet.": "ఇంకా సప్లయర్లు చేర్చలేదు.", "Add Customer": "కస్టమర్ జోడించండి",
  "+ Customer": "+ కస్టమర్", "+ Sale": "+ సేల్", "+ Worker": "+ కార్మికుడు", "+ Add": "+ జోడించండి",
  "+ Add Supplier": "+ సప్లయర్", "Adjust Stock": "స్టాక్ సర్దుబాటు", "Record Sale": "సేల్ నమోదు",
  "Add Payment": "పేమెంట్ జోడించండి", "Save Payment": "పేమెంట్ సేవ్", "Save": "సేవ్", "Cancel": "రద్దు",
  "Edit": "ఎడిట్", "Delete": "డిలీట్", "Saving…": "సేవ్ అవుతోంది…",
  "Recent Changes & Backup": "ఇటీవలి మార్పులు & బ్యాకప్", "Export Backup": "బ్యాకప్ ఎగుమతి",
  "Clear Local Log": "లోకల్ లాగ్ క్లియర్", "No changes recorded yet.": "ఇంకా మార్పులు రికార్డ్ కాలేదు.",
  "Change saved": "మార్పు సేవ్ అయింది", "Working…": "పని జరుగుతోంది…"
  ,"Select…": "ఎంచుకోండి…", "Loading…": "లోడ్ అవుతోంది…", "Loading BrickMaster Pro…": "బ్రిక్‌మాస్టర్ ప్రో లోడ్ అవుతోంది…",
  "Connection Error": "కనెక్షన్ లోపం", "Retry": "మళ్లీ ప్రయత్నించండి", "To collect": "వసూలు చేయాలి", "All 4 types": "అన్ని 4 రకాలు",
  "Alerts": "అలర్ట్స్", "Monthly Revenue vs Expenses": "నెలవారీ ఆదాయం vs ఖర్చులు", "Live Stock": "లైవ్ స్టాక్",
  "Low stock:": "తక్కువ స్టాక్:", "pcs": "పీసులు", "bricks": "ఇటుకలు", "Brick": "ఇటుక",
  "Daily Log": "రోజువారీ లాగ్", "Weekly View": "వారపు వీక్షణ", "Materials Used": "వాడిన మెటీరియల్స్",
  "Stock Out": "స్టాక్ ఔట్", "+ Add Day": "+ రోజు జోడించండి", "Add Daily Production": "రోజువారీ ఉత్పత్తి జోడించండి",
  "Date": "తేదీ", "Brick Type": "ఇటుక రకం", "Produced": "ఉత్పత్తి", "Bricks Produced": "ఉత్పత్తి చేసిన ఇటుకలు",
  "Rejections": "రిజెక్షన్లు", "Raw Materials Used Today": "ఈరోజు వాడిన ముడి సరుకు", "Ready after 5 days curing": "5 రోజుల క్యూరింగ్ తర్వాత సిద్ధం",
  "Save Production Entry": "ఉత్పత్తి నమోదు సేవ్", "Remove from Stock": "స్టాక్ నుండి తీసివేయండి", "Material": "మెటీరియల్",
  "Quantity to Remove": "తీసివేయాల్సిన పరిమాణం", "Reason (optional)": "కారణం (ఐచ్ఛికం)", "Curing Done — Ready to Add to Stock": "క్యూరింగ్ పూర్తయింది — స్టాక్‌కు జోడించడానికి సిద్ధం",
  "Add to Stock →": "స్టాక్‌కు జోడించండి →", "Ready": "సిద్ధం", "In Stock ✓": "స్టాక్‌లో ఉంది ✓", "Materials used:": "వాడిన మెటీరియల్స్:",
  "Total Consumed — All Time": "మొత్తం వినియోగం — ఇప్పటివరకు", "Stock left:": "మిగిలిన స్టాక్:", "Week:": "వారం:",
  "PRODUCED": "ఉత్పత్తి", "REJECTED": "రిజెక్ట్", "NET GOOD": "నికర మంచి",
  "Workers": "కార్మికులు", "Worker": "కార్మికుడు", "Worker Name": "కార్మికుడి పేరు", "Role": "పాత్ర", "Rate Per Brick (₹)": "ఇటుకకు రేటు (₹)",
  "Add Worker": "కార్మికుడిని జోడించండి", "Record Weekly Salary": "వారపు జీతం నమోదు", "Record This Week's Payment": "ఈ వారం చెల్లింపు నమోదు",
  "Confirm Payment": "చెల్లింపు నిర్ధారించండి", "Pay Now": "ఇప్పుడు చెల్లించండి", "Done": "పూర్తి", "Edit Payments": "చెల్లింపులు ఎడిట్",
  "Earned": "సంపాదించింది", "Total Paying": "మొత్తం చెల్లింపు", "Auto-calculated — edit if different.": "ఆటో లెక్కింపు — భిన్నంగా ఉంటే ఎడిట్ చేయండి.",
  "Machine Operator": "మెషిన్ ఆపరేటర్", "Helper": "హెల్పర్", "Driver": "డ్రైవర్", "Security": "సెక్యూరిటీ", "Supervisor": "సూపర్వైజర్", "Other": "ఇతర",
  "New Sale": "కొత్త సేల్", "Edit Sale": "సేల్ ఎడిట్", "Customer": "కస్టమర్", "Customer Name": "కస్టమర్ పేరు", "Phone Number": "ఫోన్ నంబర్",
  "Filter by Month": "నెల ఆధారంగా ఫిల్టర్", "Qty": "పరిమాణం", "Qty (bricks)": "పరిమాణం (ఇటుకలు)", "Price/Brick (₹)": "ఇటుకకు ధర (₹)",
  "Total Amount (₹)": "మొత్తం మొత్తం (₹)", "Location / City": "ప్రాంతం / నగరం", "Note": "నోట్", "Note (optional)": "నోట్ (ఐచ్ఛికం)",
  "Total": "మొత్తం", "Paid ✓": "చెల్లింపు పూర్తయింది ✓", "Due:": "బాకీ:", "Payments received / instalments:": "వచ్చిన చెల్లింపులు / వాయిదాలు:",
  "Instalment": "వాయిదా", "Edit Sale": "సేల్ ఎడిట్", "Delete": "డిలీట్", "Sale / instalment history": "సేల్ / వాయిదాల చరిత్ర",
  "Left:": "మిగిలింది:", "Sale": "సేల్", "Paid": "చెల్లించినది", "Outstanding:": "బాకీ:", "remaining": "మిగిలినది",
  "Amount Received (₹)": "వచ్చిన మొత్తం (₹)", "Payment Mode": "చెల్లింపు విధానం", "Note (e.g. 1st instalment)": "నోట్ (ఉదా: 1వ వాయిదా)",
  "Cash": "క్యాష్", "UPI": "యూపీఐ", "Cheque": "చెక్", "Bank Transfer": "బ్యాంక్ ట్రాన్స్‌ఫర్",
  "Supplier Name": "సప్లయర్ పేరు", "Phone": "ఫోన్", "Price Per Unit (₹)": "యూనిట్‌కు ధర (₹)", "Price/Unit (₹)": "యూనిట్‌కు ధర (₹)",
  "Unit": "యూనిట్", "Terms": "నిబంధనలు", "Payment Terms": "చెల్లింపు నిబంధనలు", "Bills": "బిల్లులు", "Payments": "చెల్లింపులు",
  "+ Add Bill": "+ బిల్ జోడించండి", "+ Record Payment": "+ చెల్లింపు నమోదు", "Add Bill": "బిల్ జోడించండి", "Bill Amount (₹)": "బిల్ మొత్తం (₹)",
  "Record Payment": "చెల్లింపు నమోదు", "Balance due:": "బాకీ మొత్తం:", "Confirm Payment": "చెల్లింపు నిర్ధారించండి",
  "Tap a supplier to view bills & payment history": "బిల్లులు & చెల్లింపు చరిత్ర చూడటానికి సప్లయర్‌ను ట్యాప్ చేయండి", "Settled ✓": "సెటిల్ అయింది ✓", "we owe": "మనం చెల్లించాలి", "Tap to open →": "ఓపెన్ చేయడానికి ట్యాప్ →",
  "BILLED": "బిల్ అయింది", "BALANCE": "బ్యాలెన్స్", "Rate": "రేటు", "supplied": "సరఫరా",
  "+ Stock In": "+ స్టాక్ ఇన్", "Current Stock": "ప్రస్తుత స్టాక్", "Reorder Level": "రీ ఆర్డర్ స్థాయి", "Cost Per Unit (₹)": "యూనిట్‌కు ఖర్చు (₹)",
  "Quantity to Add": "జోడించాల్సిన పరిమాణం", "Add Stock": "స్టాక్ జోడించండి", "Below reorder level — order now.": "రీ ఆర్డర్ స్థాయి కంటే తక్కువ — వెంటనే ఆర్డర్ చేయండి.",
  "Adjustment (+ add / - remove)": "సర్దుబాటు (+ జోడించు / - తీసివేయు)", "Save Adjustment": "సర్దుబాటు సేవ్",
  "Category": "కేటగిరీ", "Description": "వివరణ", "Amount (₹)": "మొత్తం (₹)", "Add Expense": "ఖర్చు జోడించండి", "Save Expense": "ఖర్చు సేవ్",
  "Electricity": "విద్యుత్", "Maintenance": "మెయింటెనెన్స్", "Marketing": "మార్కెటింగ్", "Transport": "రవాణా", "Miscellaneous": "ఇతర",
  "Reports & Analytics": "రిపోర్ట్స్ & అనలిటిక్స్", "Revenue vs Profit Trend": "ఆదాయం vs లాభం ట్రెండ్", "Monthly Bricks Produced": "నెలవారీ ఉత్పత్తి చేసిన ఇటుకలు",
  "Sales by Location": "ప్రాంతం వారీగా అమ్మకాలు", "Month-by-Month P&L": "నెలవారీ లాభనష్టం", "No report data yet.": "ఇంకా రిపోర్ట్ డేటా లేదు.",
  "No production data yet.": "ఇంకా ఉత్పత్తి డేటా లేదు.", "No location sales data yet.": "ఇంకా ప్రాంత సేల్స్ డేటా లేదు.", "Revenue:": "ఆదాయం:", "Bills:": "బిల్లులు:", "Salary:": "జీతం:", "Bricks:": "ఇటుకలు:", "Profit:": "లాభం:",
  "Backup protection": "బ్యాకప్ రక్షణ", "Latest": "తాజాది", "Clear local change log? This will not delete business data.": "లోకల్ మార్పుల లాగ్ క్లియర్ చేయాలా? ఇది వ్యాపార డేటాను డిలీట్ చేయదు.",
  "Tonnes": "టన్నులు", "Bags": "బ్యాగులు", "Kg": "కిలోలు", "Litres": "లీటర్లు", "units": "యూనిట్లు"

};

let brickmasterTranslationObserver = null;
let brickmasterIsTranslating = false;
...
const translateTextValue = (value) => {
  ...
  if (TE[trimmed]) return raw.replace(trimmed, TE[trimmed]);

  // Translate repeated UI prefixes without touching user-entered names/numbers.
  for (const [en, te] of Object.entries(TE)) {
    if (trimmed.startsWith(en + " ")) return raw.replace(en, te);
    if (trimmed.startsWith(en + ":")) return raw.replace(en, te);
  }
...
const translateDomOnce = () => {
  if (typeof document === "undefined") return;
  if (brickmasterIsTranslating) return;

  brickmasterIsTranslating = true;
  ...
  try {
    ...
    root.querySelectorAll("input, textarea, select, option, button, [title], [aria-label]").forEach((el) => {
      if (el.placeholder) el.placeholder = translateTextValue(el.placeholder);
      if (el.title) el.title = translateTextValue(el.title);
      if (el.getAttribute("aria-label")) el.setAttribute("aria-label", translateTextValue(el.getAttribute("aria-label")));
    });
  } finally {
    brickmasterIsTranslating = false;
  }
};
...
const translatePage = (lang) => {
  ...
  window.__BRICKMASTER_LANG = lang;

  if (brickmasterTranslationObserver) {
    brickmasterTranslationObserver.disconnect();
    brickmasterTranslationObserver = null;
  }

  if (lang !== "te") return;

  setTimeout(translateDomOnce, 0);

  brickmasterTranslationObserver = new MutationObserver(() => {
    if (window.__BRICKMASTER_LANG !== "te") return;
    setTimeout(translateDomOnce, 0);
  });

  if (document.body) {
    brickmasterTranslationObserver.observe(document.body, {
      childList: true,
      subtree: true,
      characterData: true,
    });
...
// ── BACKUP / UNDO / REDO HELPERS ──────────────────────────────────────────────
const BACKUP_TABLES = [
  { name: "inventory", key: "brick_type", never: "__never__" },
  { name: "raw_materials", key: "id", never: -999999999 },
  { name: "production", key: "id", never: -999999999 },
  { name: "workers", key: "id", never: -999999999 },
  { name: "salary_payments", key: "id", never: -999999999 },
  { name: "suppliers", key: "id", never: -999999999 },
  { name: "customers", key: "id", never: -999999999 },
  { name: "sales", key: "id", never: -999999999 },
  { name: "expenses", key: "id", never: -999999999 },
];
...
const writeLocalJson = (key, value) => {
  ...
  window.dispatchEvent(new Event("brickmaster-history-changed"));
};
async function createBackupSnapshot() {
  const snapshot = {};
  for (const table of BACKUP_TABLES) {
    const { data, error } = await sb.from(table.name).select("*");
...
async function restoreBackupSnapshot(snapshot) {
  for (const table of BACKUP_TABLES) {
    await sb.from(table.name).delete().neq(table.key, table.never);
    const rows = snapshot?.[table.name] || [];
    if (rows.length > 0) {
      const { error } = await sb.from(table.name).insert(rows);
      if (error) throw error;
    }
  }
}
function pushChangeLog(title, before, after) {
  const history = readLocalJson(HISTORY_KEY, []);
  const item = { id: Date.now(), title: title || "Change saved", at: new Date().toISOString(), before, after };
  writeLocalJson(HISTORY_KEY, [item, ...history].slice(0, 50));
  writeLocalJson(REDO_KEY, []);
}
const exportBackupFile = async () => {
  const snapshot = await createBackupSnapshot();
  const payload = { app: "BrickMaster Pro", exportedAt: new Date().toISOString(), snapshot, localChangeLog: readLocalJson(HISTORY_KEY, []) };
  const blob = new Blob([JSON.stringify(payload, null, 2)], { type: "application/json" });
  const url = URL.createObjectURL(blob);
  const a = document.createElement("a");
  a.href = url;
  a.download = `brickmaster-backup-${new Date().toISOString().slice(0, 10)}.json`;
...
function useSaving() {
  ...
  const save = async (fn, title = "Change saved") => {
    setSaving(true);
    let before = null;
    try {
      before = await createBackupSnapshot();
      await fn();
      const after = await createBackupSnapshot();
      pushChangeLog(title, before, after);
    } finally {
      setSaving(false);
    }
  };
...
// ── CHANGE HISTORY / BACKUP SCREEN ────────────────────────────────────────────
function BackupLog({ onUndo, onRedo, undoCount, redoCount, busy }) {
  const [logs, setLogs] = useState(readLocalJson(HISTORY_KEY, []));
  useEffect(() => {
    const sync = () => setLogs(readLocalJson(HISTORY_KEY, []));
    window.addEventListener("brickmaster-history-changed", sync);
    return () => window.removeEventListener("brickmaster-history-changed", sync);
  }, []);
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      <SH title="🕘 Recent Changes & Backup" action={<>
        <Btn sm outline color={T.blue} onClick={onUndo}>{busy ? "Working…" : `Undo (${undoCount})`}</Btn>
        <Btn sm outline color={T.purple} onClick={onRedo}>{busy ? "Working…" : `Redo (${redoCount})`}</Btn>
        <Btn sm color={T.green} onClick={exportBackupFile}>Export Backup</Btn>
        <Btn sm outline color={T.red} onClick={() => { if (window.confirm("Clear local change log? This will not delete business data.")) { writeLocalJson(HISTORY_KEY, []); writeLocalJson(REDO_KEY, []); } }}>Clear Local Log</Btn>
      </>} />
      <Card>
        <div style={{ fontWeight: 800, color: T.text, marginBottom: 8 }}>Backup protection</div>
        <div style={{ color: T.muted, fontSize: 13, lineHeight: 1.5 }}>
          Every add, edit, delete, stock adjustment and payment action now saves a database snapshot before and after the change. Undo restores the previous snapshot. Redo reapplies it. Export Backup downloads a JSON copy of the current database and local change history.
        </div>
      </Card>
      {logs.length === 0 && <Card><div style={{ color: T.muted, fontSize: 13 }}>No changes recorded yet.</div></Card>}
      {logs.map((log, index) => (
        <Card key={log.id}>
          <div style={{ display: "flex", justifyContent: "space-between", gap: 10 }}>
            <div><div style={{ fontWeight: 800, color: T.text }}>{log.title || "Change saved"}</div><div style={{ color: T.muted, fontSize: 12 }}>{new Date(log.at).toLocaleString("en-IN")}</div></div>
            <Badge color={index === 0 ? T.accent : T.blue}>{index === 0 ? "Latest" : `#${index + 1}`}</Badge>
          </div>
        </Card>
      ))}
    </div>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("brickmaster-history-changed", bump);
    return () => window.removeEventListener("brickmaster-history-changed", bump);
  }, []);

  useEffect(() => {
    localStorage.setItem(LANG_KEY, lang);
    translatePage(lang);
  }, [lang, tab, data, historyVersion]);

  const undoCount = readLocalJson(HISTORY_KEY, []).length;
  const redoCount = readLocalJson(REDO_KEY, []).length;

  const handleUndo = async () => {
    const history = readLocalJson(HISTORY_KEY, []);
    if (history.length === 0 || actionBusy) return;
    const [latest, ...rest] = history;
    setActionBusy(true);
    try {
      await restoreBackupSnapshot(latest.before);
      writeLocalJson(HISTORY_KEY, rest);
      writeLocalJson(REDO_KEY, [latest, ...readLocalJson(REDO_KEY, [])].slice(0, 50));
      await reload();
    } finally { setActionBusy(false); }
  };

  const handleRedo = async () => {
    const redo = readLocalJson(REDO_KEY, []);
    if (redo.length === 0 || actionBusy) return;
    const [latest, ...rest] = redo;
    setActionBusy(true);
    try {
      await restoreBackupSnapshot(latest.after);
      writeLocalJson(REDO_KEY, rest);
      writeLocalJson(HISTORY_KEY, [latest, ...readLocalJson(HISTORY_KEY, [])].slice(0, 50));
      await reload();
    } finally { setActionBusy(false); }
  };
  ...
  const render = () => {
    switch (tab) {
      ...
      case "customers":
        return <CustomersSales {...p} defaultTab="By Customer" />;
      case "salaries":
        return <Salaries {...p} />;
      case "expenses":
        return <Expenses {...p} />;
      case "suppliers":
        return <Suppliers {...p} />;
      case "history":
        return <BackupLog onUndo={handleUndo} onRedo={handleRedo} undoCount={undoCount} redoCount={redoCount} busy={actionBusy} />;
      case "reports":
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap", justifyContent: "flex-end" }}>
          <button onClick={() => setLang((v) => (v === "en" ? "te" : "en"))} style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 10, color: T.text, padding: "7px 11px", cursor: "pointer", fontWeight: 800 }}>{lang === "en" ? "TE" : "EN"}</button>
          <button onClick={handleUndo} disabled={undoCount === 0 || actionBusy} style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 10, color: undoCount === 0 ? T.muted : T.text, padding: "7px 11px", cursor: undoCount === 0 || actionBusy ? "not-allowed" : "pointer", fontWeight: 700 }}>Undo</button>
          <button onClick={handleRedo} disabled={redoCount === 0 || actionBusy} style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 10, color: redoCount === 0 ? T.muted : T.text, padding: "7px 11px", cursor: redoCount === 0 || actionBusy ? "not-allowed" : "pointer", fontWeight: 700 }}>Redo</button>
          <button onClick={reload} style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 10, color: T.text, padding: "7px 11px", cursor: "pointer", fontWeight: 700 }}>Refresh</button>
        </div>
      </div>
